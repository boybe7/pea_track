 ...
 *
 * The followings are the available columns in table 'contract_change_history':
 * @property integer $id
 ...
 */
class ContractChangeHistory extends CActiveRecord
{
	/**
	 ...
	 * @return ContractChangeHistory the static model class
	 */
