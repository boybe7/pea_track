...
/**
 * This is the model class for table "contract_approve_history_temp".
 *
 * The followings are the available columns in table 'contract_approve_history_temp':
 * @property integer $id
 ...
 */
class ContractApproveHistoryTemp extends CActiveRecord
{
	/**
	...
	{
		return 'contract_approve_history_temp';
	}
	...
	public function rules()
	{
		...
		return array(
			array('contract_id, dateApprove,', 'required'),
	 ...
	 * @return ContractApproveHistoryTemp the static model class
	 */
