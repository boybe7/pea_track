...
<center><h3>รายงานการวินิจฉัยโรคตามช่วงเวลา</h3>
               ...
               $.ajax({
                       ...
                       dataType: "json"
                         ...
                         $('#printarea').html('<table class="table table-bordered" style="background-color: white" name="tgrid" id="tgrid" width="100%" cellpadding="0" cellspacing="0">'+
                                    '<thead ><tr><th  style="text-align: center">ชื่อการวินิจฉัยโรค</th>'+                       
                                            '<th class="fixwidth" style="text-align: center;width: 300px">จำนวนผู้ป่วย(คน)</th>'+
                        ...
                        if(data==null)
                        {
                            ...
                            $.each(data, function(idx, val) {
                                $('#tgrid').find('tbody').append('<tr><td>'+val["name"]+'</td><td style="text-align:center">'+parseInt(val["no"])+'</td></tr>');
                            });
                            }     
                    });
     });   
