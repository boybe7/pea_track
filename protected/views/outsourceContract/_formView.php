...
<fieldset class="well the-fieldset">
        ...
        <div class="row-fluid">
            <div class="span3">     
              ...
              <?php echo CHtml::activeTextField($model, '[' . $index . ']oc_PO', array('size' => 200, 'maxlength' => 255,'class'=>'span12','readonly'=>true)); ?>
              <?php echo CHtml::error($model, '[' . $index . ']oc_PO',array('class'=>'help-block error')); ?>
            </div>
            <div class="span7">     
              <?php echo CHtml::activeLabelEx($model, '[' . $index . ']oc_detail'); ?>
              <?php echo CHtml::activeTextArea($model, '[' . $index . ']oc_detail', array('rows' => 2, 'maxlength' => 255,'class'=>'span12','readonly'=>true)); ?>
               ...
               <?php 
                    ...
                    echo '<div class="input-append" style="margin-top:0px;">'; //ใส่ icon ลงไป
                        ...
                        array(
                            ...
                            'htmlOptions'=>array('class'=>'span8','readonly'=>true),  // ใส่ค่าเดิม ในเหตุการ Update 
                         )
                    );
        ...
        <div class="row-fluid">
          <div class="span5">     
              ...
              <?php echo CHtml::activeTextField($model, '[' . $index . ']oc_guarantee', array('size' => 20, 'maxlength' => 255,'class'=>'span12','readonly'=>true)); ?>
          ...
          <div class="span5">     
              ...
              <?php echo CHtml::activeTextField($model, '[' . $index . ']oc_adv_guarantee', array( 'maxlength' => 255,'class'=>'span12','readonly'=>true)); ?>
        ...
        <div class="row-fluid">
          <div class="span5">     
              ...
              <?php echo CHtml::activeTextField($model, '[' . $index . ']oc_guarantee_cf', array('size' => 20, 'maxlength' => 255,'class'=>'span12','readonly'=>true)); ?>
          ...
          <div class="span5">     
              ...
              <?php echo CHtml::activeTextField($model, '[' . $index . ']oc_adv_guarantee_cf', array( 'maxlength' => 255,'class'=>'span12','readonly'=>true)); ?>
        ...
        <div class="row-fluid">
          <div class="span5">     
              ...
              <?php echo CHtml::activeTextField($model, '[' . $index . ']oc_insurance', array('size' => 20, 'maxlength' => 255,'class'=>'span12','readonly'=>true)); ?>
