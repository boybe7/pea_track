...
class Bootstrap extends CApplicationComponent
{
	...
	public function registerAllCss()
	{
		...
		Yii::app()->clientScript->registerCssFile($this->getAssetsUrl().'/bootstrap-datepicker/css/datepicker.css');
                Yii::app()->clientScript->registerCssFile($this->getAssetsUrl().'/bootstrap-timepicker/css/timepicker.css');
